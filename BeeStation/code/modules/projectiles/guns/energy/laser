...
/obj/item/gun/energy/laser/scatter/shotgun
	name = "laser shotgun"
	icon_state = "lasercannon"
	item_state = "laser"
	desc = "A modified laser rifle, designed to shoot a spread of lethal laser pellets."
	ammo_type = list(/obj/item/ammo_casing/energy/laser/scatter/lasershotgun )
